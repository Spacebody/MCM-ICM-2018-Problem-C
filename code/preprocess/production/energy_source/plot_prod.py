...
plt.plot(az_hytcb["Year"], az_hytcb["Data"], label="Hydroelectricity")
...
plt.plot(ca_hytcb["Year"], ca_hytcb["Data"], label="Hydroelectricity")
...
plt.plot(nm_hytcb["Year"], nm_hytcb["Data"], label="Hydroelectricity")
...
plt.plot(tx_hytcb["Year"], tx_hytcb["Data"], label="Hydroelectricity")
