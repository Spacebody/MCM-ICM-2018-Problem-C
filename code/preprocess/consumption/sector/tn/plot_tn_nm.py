...
plt.title(
    "Total Consumption(Excluding electrical system energy losses) by Sectors of New Mexico")
plt.xlabel("Year")
...
plt.savefig(
    "code/preprocess/consumption/sector/figures/tn/Sectors_New_Mexico.png")
plt.savefig(
    "code/preprocess/consumption/sector/figures/tn/Sectors_New_Mexico.pdf")
