...
from te_nm import teacb_data, teccb_data, teeib_data, teicb_data, tercb_data


#plot
sns.set_style("darkgrid")
fig = plt.figure(figsize=(10, 5))
plt.title("Total Consumption by Sectors of New Mexico")
plt.xlabel("Year")
...
plt.savefig(
    "code/preprocess/consumption/sector/figures/te/Sectors_New_Mexico.png")
plt.savefig(
    "code/preprocess/consumption/sector/figures/te/Sectors_New_Mexico.pdf")
