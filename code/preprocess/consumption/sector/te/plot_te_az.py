...
from te_az import teacb_data, teccb_data, teeib_data, teicb_data, tercb_data


#plot
sns.set_style("darkgrid")
fig = plt.figure(figsize=(10, 5))
plt.title("Total Consumption by Sectors of Arizona")
plt.xlabel("Year")
...
plt.savefig("code/preprocess/consumption/sector/figures/te/Sectors_Arizona.png")
plt.savefig("code/preprocess/consumption/sector/figures/te/Sectors_Arizona.pdf")
