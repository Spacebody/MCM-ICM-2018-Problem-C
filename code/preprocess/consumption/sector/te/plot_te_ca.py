...
from te_ca import teacb_data, teccb_data, teeib_data, teicb_data, tercb_data


#plot
sns.set_style("darkgrid")
fig = plt.figure(figsize=(10, 5))
plt.title("Total Consumption by Sectors of California")
plt.xlabel("Year")
...
plt.savefig("code/preprocess/consumption/sector/figures/te/Sectors_California.png")
plt.savefig("code/preprocess/consumption/sector/figures/te/Sectors_California.pdf")
