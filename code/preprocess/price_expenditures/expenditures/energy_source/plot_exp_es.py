...
from exp_es_data import az_cltcv_data, az_estcv_data, az_ngtcv_data, az_nuetv_data, az_patcv_data, \
    ca_cltcv_data, ca_estcv_data, ca_ngtcv_data, ca_nuetv_data, ca_patcv_data, \
    nm_cltcv_data, nm_estcv_data, nm_ngtcv_data, nm_nuetv_data, nm_patcv_data, \
    tx_cltcv_data, tx_estcv_data, tx_ngtcv_data, tx_nuetv_data, tx_patcv_data

#plot
# az
sns.set_style("darkgrid")
fig = plt.figure(figsize=(10, 5))
plt.title("Total Expenditures by Energy Source of Arizona")
plt.xlabel("Year")
...
sns.set_style("darkgrid")
fig = plt.figure(figsize=(10, 5))
plt.title("Total Expenditures by Energy Source of California")
plt.xlabel("Year")
plt.ylabel("Data/Million dollars")
...
sns.set_style("darkgrid")
fig = plt.figure(figsize=(10, 5))
plt.title("Total Expenditures by Energy Source of New Mexico")
plt.xlabel("Year")
plt.ylabel("Data/Million dollars")
...
sns.set_style("darkgrid")
fig = plt.figure(figsize=(10, 5))
plt.title("Total Expenditures by Energy Source of Texas")
plt.xlabel("Year")
plt.ylabel("Data/Million dollars")
