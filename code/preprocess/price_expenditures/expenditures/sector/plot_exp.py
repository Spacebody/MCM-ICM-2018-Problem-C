...
plt.title("Total Expenditures(Sectors) of Arizona")
plt.xlabel("Year")
...
sns.set_style("darkgrid")
fig = plt.figure(figsize=(10, 5))
plt.title("Total Expenditures(Sectors) of California")
plt.xlabel("Year")
plt.ylabel("Data / Million dollars")
...
sns.set_style("darkgrid")
fig = plt.figure(figsize=(10, 5))
plt.title("Total Expenditures(Sectors) of New Mexico")
plt.xlabel("Year")
plt.ylabel("Data / Million dollars")
...
sns.set_style("darkgrid")
fig = plt.figure(figsize=(10, 5))
plt.title("Total Expenditures(Sectors) of Texas")
plt.xlabel("Year")
plt.ylabel("Data / Million dollars")
