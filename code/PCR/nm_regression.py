...
x_data = pd.read_csv("C:\\Users\\THINKPAD\\PycharmProjects\\MCM-ICM-2018-Problem-C\\code\\PCR\\nm_result.csv",
                       skiprows=None, engine='c', low_memory=True)
y_data = pd.read_csv("C:\\Users\\THINKPAD\\PycharmProjects\\MCM-ICM-2018-Problem-C\\code\\PCR\\nm_Total.csv",
                       skiprows=None, engine='c', low_memory=True)
original_data = pd.read_csv("C:\\Users\\THINKPAD\\PycharmProjects\\MCM-ICM-2018-Problem-C\\code\\PCR\\nm_data_by_year_original.csv",
                       skiprows=None, engine='c', low_memory=True)
...
for i in range(1962, 2008):
    ...
    data.to_csv("C:\\Users\\THINKPAD\\PycharmProjects\\MCM-ICM-2018-Problem-C\\code\PCR\\nm_regression_x.csv",
