...
#         self.yaxis.set_major_formatter(tk.FormatStrFormatter(fmt))
#     if angle is None:
...
# #data
# variables = ("Production / Thousand", "Consumption / Billion Btu", \
# "Production Per Capita / Billion Btu/Thousand / ", "Consumption Per Capita / Billion Btu/Thousand")
# ranges = [(0, 700000), (0, 800000), (0, 100), (0, 20)]
# az_data = (az_reprb, az_retcb, az_reprb/az_tpopp, az_retcb/az_tpopp)
# # plot
# fig1 = plt.figure(figsize=(6, 6))
# radar = ComplexRadar(fig1, variables, ranges)
# radar.plot(az_data)
# radar.fill(az_data, alpha=0.2)
# plt.show()
